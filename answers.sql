...
SELECT melons.common_name, melons.melon_type, order_items.quantity, order_items.unit_price, order_items.total_price FROM order_items JOIN melons ON (melons.id=order_items.melon_id) WHERE order_id = 2725;
